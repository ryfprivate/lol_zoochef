...
namespace com.dotdothorse.zoochef
{
    public class SceneLoader : MonoBehaviour
    {
        ...
        private void LoadLevel(GameSceneSO levelScene)
        {
            levelScene.sceneReference.LoadSceneAsync(LoadSceneMode.Additive, true, 0)
                .Completed += OnLevelLoaded;
        }
